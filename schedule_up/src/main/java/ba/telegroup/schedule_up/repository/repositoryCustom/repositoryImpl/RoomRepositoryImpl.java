...
public class RoomRepositoryImpl implements RoomRepositoryCustom {
    ...
    private static final String SQL_GET_ALL_EXTENDED_BY_COMPANY_NAME_WHERE_DELETED_IS_FALSE = "SELECT r.id, r.name, r.floor,r.capacity,r.pin,r.description,r.building_id, r.company_id, b.name FROM room r JOIN building b ON r.building_id=b.id WHERE r.deleted=0 AND r.company_id=?";

    @PersistenceContext
    private EntityManager entityManager;

    @Override
    public List<RoomBuilding> getAllExtendedByCompanyId(Integer id){
